...
private static Interaction connSupport;
	...
	public void testRequest() {
		...
		IApplMessage req  = CommUtils.buildRequest( "simonesgalla", "distance", "distance(20)", "consumer");
		IApplMessage req1 = CommUtils.buildRequest( "simonesgalla", "distance", "distance(30)", "consumer");
 		try {
	...
	public void testDispatch() {
		...
		//Funge da Producer come ProducerUsingConnection
		IApplMessage msg  = CommUtils.buildDispatch( "simonesgalla", "distance", "distance(30)", "consumer");
		IApplMessage msg1 = CommUtils.buildDispatch( "simonesgalla", "distance", "distance(10)", "consumer");
		try {
	...
	protected void readLogFile() throws IOException {	
		...
		IApplMessage m;
	      ...
	      m = new ApplMessage(line);
	      CommUtils.outblue( ""+m  );
	      assertEquals(m.msgContent(), "distance(10)");	      
	      myReader.close();
	}
}
