...
//    }
    ...
    protected void observe(IActor24 a) {
    	a.addObserver(this.name);
    }
    
    public void addObserver(String a) {
    	observerList.add(a);
    }
    
    public void updateResources(String s) {
    	for (String a : this.observerList) {
    		IApplMessage msg=CommUtils.buildDispatch(name, "update", s, a);
    		this.sendMsg(msg, ctx);
    	}
    }
}
